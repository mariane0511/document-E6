<style>
    ...
    * { box-sizing: border-box; }
    ...
    .logo i { font-size: 32px; color: #ef4444; }
    ...
    .menu-item:hover { background: #f3f4f6; color: #ef4444; }
    .menu-item.active { background: #ef4444; color: white; }
    ...
    .main-content { flex: 1; padding: 40px 50px; overflow-y: auto; min-height: 100vh; }
</style>
